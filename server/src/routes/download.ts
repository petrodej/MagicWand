...
$cmdFiles = @("__init__.py", "execute.py", "screenshot.py", "system_info.py", "processes.py", "event_logs.py", "services.py", "software.py", "files.py", "network.py", "input_control.py", "file_manager.py")
